      ...
      <div class="row">
          ...
          <div class="col-lg-4">
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <p class="komunitas">Zero Waste ehe</p>
                      ...
                      <div class="row">
                          <div class="mr-auto text-left pl-minus">
                              <a class="nav-link warna" href="share.php"><i
                                      class="fas fa-share-alt mr-3 warna"></i></a>
                          </div>
                          <div class="pr-15">
                              <a href="rincian-artikel.php" class="btn btn-edit">Selengkapnya</a>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div class="col-lg-4">
              <div class="card">
                  ...
                  <div class="card-body">
                      <div class="jenis-artikel btn-edit">Desember, 21 2022</div>
                      <p class="komunitas">Dari Sampah menjadi Harta</p>
                      <h4 class="judul-artikel">Pentingnya Mengelola Sampah Plastik</h4>
                      <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor
                          numquam, natus sequi blanditiis, accusamus repellendus libero.</p>
                      <hr>
          ...
          <div class="col-lg-4">
              <div class="card">
                  ...
                  <div class="card-body">
                      <div class="jenis-artikel btn-edit">Desember, 21 2022</div>
                      <p class="komunitas">Inisiatif Berbasis Masyarakat</p>
                      <h4 class="judul-artikel">Pentingnya Mengelola Sampah Plastik</h4>
                      <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor
                          numquam, natus sequi blanditiis, accusamus repellendus libero.</p>
                      <hr>
